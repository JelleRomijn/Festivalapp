...
const ACTS = [
  ...
  { id: 2,  name: 'Kensington',        stage_id: 1, day: 1, start: '13:15', end: '15:15', genre: 'Rock',
  ...
  { id: 3,  name: 'De Staat',          stage_id: 1, day: 1, start: '15:45', end: '17:45', genre: 'Rock',
  ...
  { id: 4,  name: 'Navarone',          stage_id: 1, day: 1, start: '18:15', end: '20:15', genre: 'Rock',
  ...
  { id: 5,  name: 'Dotan',             stage_id: 1, day: 1, start: '20:45', end: '22:15', genre: 'Singer-songwriter',
  ...
  { id: 6,  name: 'Froukje',           stage_id: 1, day: 1, start: '22:30', end: '23:45', genre: 'Pop',
  ...
  // Zaterdag — The Lake
  { id: 7,  name: 'Talent set 1',      stage_id: 2, day: 1, start: '10:00', end: '11:15', genre: 'Talent' },
  { id: 8,  name: 'Talent set 2',      stage_id: 2, day: 1, start: '11:45', end: '13:00', genre: 'Talent' },
  { id: 9,  name: 'Talent set 3',      stage_id: 2, day: 1, start: '13:30', end: '14:45', genre: 'Talent' },
  { id: 10, name: 'Talent set 4',      stage_id: 2, day: 1, start: '15:15', end: '16:30', genre: 'Talent' },
  { id: 11, name: 'Talent set 5',      stage_id: 2, day: 1, start: '17:00', end: '18:15', genre: 'Talent' },
  { id: 12, name: 'Talent set 6',      stage_id: 2, day: 1, start: '19:00', end: '20:15', genre: 'Talent' },
  { id: 13, name: 'Talent set 7',      stage_id: 2, day: 1, start: '22:00', end: '23:45', genre: 'Talent' },

  // Zaterdag — The Club
  { id: 14, name: 'Comedy',            stage_id: 3, day: 1, start: '11:30', end: '13:00', genre: 'Cabaret' },
  { id: 15, name: 'Lecture',           stage_id: 3, day: 1, start: '13:30', end: '15:00', genre: 'Lezing' },
  { id: 16, name: 'Theater',           stage_id: 3, day: 1, start: '15:30', end: '17:00', genre: 'Theater' },
  { id: 17, name: 'Movie',             stage_id: 3, day: 1, start: '18:00', end: '20:00', genre: 'Film' },
  { id: 18, name: 'Performance',       stage_id: 3, day: 1, start: '20:30', end: '22:00', genre: 'Performance' },
  { id: 19, name: 'Illusionist',       stage_id: 3, day: 1, start: '22:15', end: '23:45', genre: 'Magie' },

  // Zaterdag — Hanggar
  { id: 20, name: 'DJ set 1',          stage_id: 4, day: 1, start: '10:00', end: '11:15', genre: 'DJ' },
  { id: 21, name: 'DJ set 2',          stage_id: 4, day: 1, start: '11:30', end: '12:45', genre: 'DJ' },
  { id: 22, name: 'DJ set 3',          stage_id: 4, day: 1, start: '13:15', end: '14:30', genre: 'DJ' },
  { id: 23, name: 'DJ set 4',          stage_id: 4, day: 1, start: '15:00', end: '16:15', genre: 'DJ' },
  { id: 24, name: 'DJ set 5',          stage_id: 4, day: 1, start: '16:45', end: '18:00', genre: 'DJ' },
  { id: 25, name: 'DJ set 6',          stage_id: 4, day: 1, start: '18:30', end: '19:45', genre: 'DJ' },
  ...
  { id: 29, name: 'Within Temptation', stage_id: 1, day: 2, start: '13:30', end: '15:30', genre: 'Symphonic metal',
  ...
  { id: 30, name: "Chef'Special",      stage_id: 1, day: 2, start: '16:00', end: '17:45', genre: 'Pop / Rock',
  ...
  { id: 31, name: 'Eefje de Visser',   stage_id: 1, day: 2, start: '19:15', end: '21:00', genre: 'Indie pop',
  ...
  { id: 32, name: 'Spinvis',           stage_id: 1, day: 2, start: '21:30', end: '23:45', genre: 'Electro pop',
  ...
  // Zondag — The Lake
  { id: 33, name: 'Talent set 1',      stage_id: 2, day: 2, start: '10:00', end: '11:15', genre: 'Talent' },
  { id: 34, name: 'Talent set 2',      stage_id: 2, day: 2, start: '11:45', end: '13:00', genre: 'Talent' },
  { id: 35, name: 'Talent set 3',      stage_id: 2, day: 2, start: '14:00', end: '15:30', genre: 'Talent' },
  { id: 36, name: 'Talent set 4',      stage_id: 2, day: 2, start: '16:00', end: '17:30', genre: 'Talent' },
  { id: 37, name: 'Talent set 5',      stage_id: 2, day: 2, start: '18:30', end: '20:00', genre: 'Talent' },
  { id: 38, name: 'Talent set 6',      stage_id: 2, day: 2, start: '21:00', end: '22:30', genre: 'Talent' },

  // Zondag — The Club
  { id: 39, name: 'Comedy',            stage_id: 3, day: 2, start: '11:30', end: '13:00', genre: 'Cabaret' },
  { id: 40, name: 'Lecture',           stage_id: 3, day: 2, start: '13:30', end: '15:00', genre: 'Lezing' },
  { id: 41, name: 'Theater',           stage_id: 3, day: 2, start: '15:30', end: '17:00', genre: 'Theater' },
  { id: 42, name: 'Movie',             stage_id: 3, day: 2, start: '18:00', end: '19:30', genre: 'Film' },
  { id: 43, name: 'Magic Show',        stage_id: 3, day: 2, start: '21:00', end: '22:45', genre: 'Magie' },

  // Zondag — Hanggar
  { id: 44, name: 'DJ set 1',          stage_id: 4, day: 2, start: '10:00', end: '11:00', genre: 'DJ' },
  { id: 45, name: 'DJ set 2',          stage_id: 4, day: 2, start: '11:30', end: '12:45', genre: 'DJ' },
  { id: 46, name: 'DJ set 3',          stage_id: 4, day: 2, start: '13:30', end: '14:45', genre: 'DJ' },
  { id: 47, name: 'DJ set 4',          stage_id: 4, day: 2, start: '15:15', end: '16:30', genre: 'DJ' },
  { id: 48, name: 'DJ set 5',          stage_id: 4, day: 2, start: '17:00', end: '18:15', genre: 'DJ' },
  { id: 49, name: 'DJ set 6',          stage_id: 4, day: 2, start: '18:45', end: '20:15', genre: 'DJ' },
  { id: 50, name: 'DJ set 7',          stage_id: 4, day: 2, start: '20:45', end: '22:15', genre: 'DJ' },
  { id: 51, name: 'DJ set 8',          stage_id: 4, day: 2, start: '22:30', end: '23:45', genre: 'DJ' },
];
...
const TEXTS = {
  nl: {
    title: 'Programma',
    subtitle: 'LoveU Festival 2026 — twee dagen vol muziek',
    day1: 'Za 15 aug',
    day2: 'Zo 16 aug',
  ...
  en: {
    title: 'Schedule',
    subtitle: 'LoveU Festival 2026 — two days of music',
    day1: 'Sat 15 Aug',
    day2: 'Sun 16 Aug',
